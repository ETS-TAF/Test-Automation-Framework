...
import gatling.GatlingController;
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                try {
                    out = new FileOutputStream("./gatling/test_plan.xml");
                    ...
                    // Lancement du test Gatling
                    GatlingController gatlingController = new GatlingController();
                    gatlingController.runTest("./test_plan.xml");
